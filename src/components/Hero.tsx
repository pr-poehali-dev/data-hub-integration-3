        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col gap-6">
            <div className="inline-flex items-center gap-2 bg-accent/10 text-accent px-4 py-2 rounded-full w-fit">
              ...
              <span className="text-sm font-medium">Обучение для детей 6–10 лет</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight text-balance">
              Английский язык для детей начальной школы
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Интерактивные занятия в игровом формате. Ребёнок полюбит английский, научится говорить,
              читать и понимать — весело и без стресса.
            </p>
            ...
            <div className="flex gap-8 pt-4 text-sm">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Рейтинг курса</p>
              </div>
              <div>
          ...
          <div className="relative h-96 md:h-full min-h-96">
            ...
            <img
              ...
              alt="Обучение английскому языку для детей"
